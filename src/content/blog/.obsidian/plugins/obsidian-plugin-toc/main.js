...
var B = (u, D) => () => (
    D || ((D = { exports: {} }), u(D.exports, D)), D.exports
  ),
  X = (u, D) => {
...
var S = B((gD, y) => {
  y.exports = (u) =>
    u != null && typeof u == 'object' && u.constructor !== RegExp
})
var M = B((hD, L) => {
  'use strict'
  function m(u) {
    ...
    for (let C = 0; C < u.length; C++)
      if (((F += u[C]), C < D.length)) {
        let e = D[C],
          t = !1
        if (
          (P.default(e).value && ((e = P.default(e).value), (t = !0)),
          (e && e[h]) || t)
        ) {
          let E = F.split(`
`),
...
var j = B((fD, I) => {
  I.exports = function (u, D) {
    ;(D = D || {}),
      (D.listUnicodeChar = D.hasOwnProperty('listUnicodeChar')
        ? D.listUnicodeChar
        : !1),
      (D.stripListLeaders = D.hasOwnProperty('stripListLeaders')
        ? D.stripListLeaders
        : !0),
      (D.gfm = D.hasOwnProperty('gfm') ? D.gfm : !0),
      (D.useImgAltText = D.hasOwnProperty('useImgAltText')
        ? D.useImgAltText
        : !0),
      ...
      (D.replaceLinksWithURL = D.hasOwnProperty('replaceLinksWithURL')
        ...
        : !1),
      (D.htmlTagsToSkip = D.hasOwnProperty('htmlTagsToSkip')
        ? D.htmlTagsToSkip
        : [])
    var F = u || ''
...
var R = B((mD, N) => {
  ...
  function nD(u, D) {
    return (
      (u = U(u)), D && (u += '-' + D), (u = u.replace(eD(), '')), (u = tD(u)), u
    )
  }
  function ED(u, D) {
    return (
      (u = 'markdown-header-' + U(u)),
      (u = u.replace(/--+/g, '-')),
      D && (u += '_' + D),
      u
    )
  ...
  N.exports = function (D, F, C, e) {
    ...
    switch (F) {
      ...
      case 'nodejs.org':
        if (!e)
          throw new Error('Need module name to generate proper anchor for ' + F)
        t = function (a, l) {
          return CD(e + '.' + a, l)
        }
        break
        ...
        new r.Setting(D)
          ...
          .addSlider((e) =>
            e
              ...
              .setLimits(1, 6, 1)
              .onChange((t) => {
                ;(this.plugin.settings.minimumDepth = t),
                  this.plugin.saveData(this.plugin.settings)
              }),
          ),
        new r.Setting(D)
          ...
          .addSlider((e) =>
            e
              ...
              .setLimits(1, 6, 1)
              .onChange((t) => {
                ;(this.plugin.settings.maximumDepth = t),
                  this.plugin.saveData(this.plugin.settings)
              }),
          ),
        new r.Setting(D)
          ...
          .setDesc(
            'Auto-generate Markdown links, instead of the default WikiLinks',
          )
          .addToggle((e) =>
      ...
      let C = new r.Setting(D)
        ...
        .addToggle((e) =>
          e
            ...
            .setDisabled(!this.plugin.settings.useMarkdown)
            .onChange((t) => {
              ;(this.plugin.settings.githubCompat = t),
                this.plugin.saveData(this.plugin.settings)
            }),
        )
    }
