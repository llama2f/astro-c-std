...
var BlockUtils = class _BlockUtils {
  static getBlock(app2, editor, file) {
    ...
    let currentBlock =
      foundSectionIndex > 0
        ? sections[foundSectionIndex - 1]
        : sections[sections.length - 1]
    if ((currentBlock == null ? void 0 : currentBlock.type) == 'list') {
      currentBlock =
        (_b =
          (_a = fileCache.listItems) == null
            ? void 0
            : _a.find(
                (section) =>
  ...
  static getBlockId(app2) {
    const view = app2.workspace.getActiveViewOfType(
...
function getAlternativeFilePath(app2, file) {
  ...
  for (let index = 1; index < 100; index++) {
    ...
    const alternative =
      formattedDir + (formattedDir == '' ? '' : '/') + base + ` ${index}.md`
...
function getEndAndBeginningOfHeading(app2, file, heading) {
  ...
  const foundHeading =
    (_a = cache.headings) == null
      ? void 0
      : _a.find((e) => e.heading === heading)
  if (foundHeading) {
    const foundSectionIndex = sections.findIndex(
      (section) =>
    ...
    const nextHeadingIndex =
      restSections == null
        ? void 0
        : restSections.findIndex((e) => e.type === 'heading')
    const lastSection =
      (_b =
        restSections[
          (nextHeadingIndex !== -1 ? nextHeadingIndex : restSections.length) - 1
        ]) != null
        ? _b
    ...
    if (parameters.filepath) {
      if (parameters.mode) {
        if (parameters.mode == 'new') {
          ...
          if (file instanceof import_obsidian7.TFile) {
            parameters.filepath = getAlternativeFilePath(this.app, file)
          }
        }
...
var Tools = class {
  ...
  async writeUIDToFile(file, uid) {
    var _a
    const frontmatter =
      (_a = this.app.metadataCache.getFileCache(file)) == null
        ? void 0
        : _a.frontmatter
  ...
  async generateURI(parameters, doubleEncode) {
    ...
    if (
      ...
      if (!this.settings.addFilepathWhenUsingUID) parameters.filepath = void 0
      parameters.uid = await this.getUIDFromFile(file)
    }
    const sortedParameterKeys = Object.keys(parameters)
...
var AdvancedURI = class extends import_obsidian14.Plugin {
  ...
  async onload() {
        ...
        fileModal.onChooseItem = (filePath) => {
          ...
          searchModal.onChooseSuggestion = (item) => {
            new ReplaceModal(
              this,
              item,
              filePath == null ? void 0 : filePath.source,
            ).open()
          }
        }
      },
    ...
    this.addCommand({
      ...
      checkCallback: (checking) => {
        ...
        if (checking) return view != void 0
      ...
      checkCallback: (checking) => {
        ...
        if (checking) {
          return (
            ...
            activeView.canvas.selection.size > 0
          )
        }
    ...
    this.registerObsidianProtocolHandler('advanced-uri', async (e) => {
      ...
      if (parameters.uid) {
        const res =
          (_a = this.tools.getFileFromUID(parameters.uid)) == null
            ? void 0
            : _a.path
        if (res != void 0) {
        ...
        const parentFolderPath = parentFolder.isRoot()
          ...
          : parentFolder.path + '/'
        parameters.filepath =
          (_c = file == null ? void 0 : file.path) != null
            ? _c
            : parentFolderPath +
              (0, import_obsidian14.normalizePath)(parameters.filename)
      }
      if (parameters.filepath) {
        parameters.filepath = (0, import_obsidian14.normalizePath)(
          parameters.filepath,
        )
        ...
        const allDailyNotes = (0,
        import_obsidian_daily_notes_interface2.getAllDailyNotes)()
        let dailyNote = (0,
        import_obsidian_daily_notes_interface2.getDailyNote)(
          moment,
          allDailyNotes,
        )
        if (!dailyNote) {
          if (parameters.exists === 'true') {
            ...
            dailyNote = await (0,
            import_obsidian_daily_notes_interface2.createDailyNote)(moment)
    ...
    this.registerObsidianProtocolHandler('hook-get-advanced-uri', async (e) => {
      const parameters = e
      for (const parameter in parameters) {
        parameters[parameter] = decodeURIComponent(parameters[parameter])
      }
  ...
  async append(file, parameters) {
    ...
    if (parameters.heading) {
      if (file instanceof import_obsidian14.TFile) {
        path = file.path
        const line =
          (_a = getEndAndBeginningOfHeading(
            this.app,
            file,
            parameters.heading,
          )) == null
  ...
  async open({ file, setting, parameters, supportPopover, mode }) {
    if (
      parameters.openmode == 'popover' &&
      (supportPopover != null ? supportPopover : true)
    ) {
      ...
      if (parameters.openmode !== void 0) {
        if (parameters.openmode == 'true' || parameters.openmode == 'false') {
          ...
          import_obsidian14.Platform.isMobile &&
      ...
      if (isBoolean(openMode)) {
        this.app.workspace.iterateAllLeaves((leaf) => {
          var _a
          if (
            ((_a = leaf.view.file) == null ? void 0 : _a.path) ===
            parameters.filepath
          ) {
