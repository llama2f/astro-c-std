...
var MicroLinkParser = class extends Parser {
  ...
  process(data) {
    ...
    const image =
      ((_a = data.data.image) == null ? void 0 : _a.url) ||
      ((_b = data.data.logo) == null ? void 0 : _b.url) ||
      ''
...
var LocalParser = class extends Parser {
  ...
  getHtmlByRequest(url) {
    return __async(this, null, function* () {
      const html = yield (0, import_obsidian2.requestUrl)({ url }).then(
        (site) => {
          return site.text
        },
      )
  ...
  getHtmlByElectron(url) {
    return __async(this, null, function* () {
      try {
        ...
        let doc = yield window.webContents.executeJavaScript(
  ...
  parse(url) {
    return __async(this, null, function* () {
      let html =
        (yield this.getHtmlByElectron(url)) ||
        (yield this.getHtmlByRequest(url))
      ...
      return __spreadProps(
        __spreadValues({}, this.process({ title, image, description })),
        { url },
      )
    })
  }
...
var ObsidianLinkEmbedPlugin = class extends import_obsidian5.Plugin {
  ...
  checkUrlValid(selected) {
    if (
      !(
        selected.text.length > 0 && ObsidianLinkEmbedPlugin.isUrl(selected.text)
      )
    ) {
  ...
  embedUrl(_0, _1, _2) {
    return __async(
      ...
      function* (
        ...
        const dummyEmbed =
          mustache_default.render(template, {
            title: 'Fetching',
            image: SPINNER,
