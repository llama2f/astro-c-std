    ...
    addIn(e, t) {
      if (Ce(e)) this.add(t)
        ...
        let [s, ...i] = e,
          r = this.get(s, !0)
        if (A(r)) r.addIn(i, t)
        else if (r === void 0 && this.schema) this.set(s, _e(this.schema, i, t))
        else
          throw new Error(
...
`.repeat(Math.max(0, o.length - 1))
  ...
  for (let d = 0; d < a; ++d) {
    let [m, g] = o[d]
    if (g === '' || g === '\r') i.indent === 0 && m.length > l && (l = m.length)
    else {
      if (m.length < l) {
        let w =
...
function ws(n, e = {}) {
  ...
  return s && t && (o.errors.forEach(ls(n, t)), o.warnings.forEach(ls(n, t))), o
}
var Vt = class {
  constructor(e, t, s, i) {
    ;(this.app = e),
...
`)
    ...
    let o = !1,
      a = r.toJSON()
    function l(f, p, u = !1) {
      tt.setScalarValue(f.srcToken, p, { afterKey: u }), (o = !0), (f.value = p)
    }
    function c(f, p) {
      let u = r.get(f, !0)
      if (!u) return
